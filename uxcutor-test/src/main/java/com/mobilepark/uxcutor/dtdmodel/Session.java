...
public class Session {
    ...
    @XmlAttribute(name = "saveend")
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    protected String saveend;
    protected List<Saved> saved;
     ...
     *     
     */
    public void setSaveend(String value) {
        this.saveend = value;
    }
     ...
     * This is why there is not a <CODE>set</CODE> method for the saved property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSaved().add(newItem);
     * </pre>
     * 
     * 
     * <p>
